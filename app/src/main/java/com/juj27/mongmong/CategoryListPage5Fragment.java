...
public class CategoryListPage5Fragment extends Fragment {
    ...
    public CategoryListPage5Fragment(String category, String subcategory) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //데이터 불러오기
        //items.add(new RecyclerListItem(1,"dd","","hh","ㅁㅁ","22",0,"233"));
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_category_page5,container,false);
    }
