...
public class CategoryListPage2Fragment extends Fragment {
    ...
    public CategoryListPage2Fragment(String category, String subcategory) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //데이터 불러오기
//        items.add(new RecyclerListItem(1,"ww","","ff","ㅁㅁ","22",0,"233"));
        loadData();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_category_page2,container,false);
    }
